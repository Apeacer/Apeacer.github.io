!function e(t, n, r) {
    ...
    1: [function(e, t) {
        ...
        t.exports = function(e) {
            ...
            e.ACL = function(t) {
                var r = this;
                if (r.permissionsById = {}, n.isObject(t))
                    if (t instanceof e.User)
                        r.setReadAccess(t, !0), r.setWriteAccess(t, !0);
                    else {
                        if (n.isFunction(t))
                ...
                if (r instanceof e.User ? r = r.id : r instanceof e.Role && (r = "role:" + r.getName()), !n.isString(r))
    ...
    3: [function(e, t) {
        ...
        t.exports = function(e) {
            Object.defineProperty(e, "BigQuery", {
                get: function() {
                    return console.warn("AV.BigQuery is deprecated, please use AV.Insight instead."), e.Insight
                }
            })
        }
    }, {}],
        ...
        t.exports = function(e) {
            ...
            e.Events = {
                on: function(e, n, r) {
                    ...
                    if (!n)
                        return this;
                    for (e = e.split(t), i = this._callbacks || (this._callbacks = {}), s = e.shift(); s;)
                        u = i[s], a = u ? u.tail : {}, a.next = o = {}, a.context = r, a.callback = n, i[s] = {
                            tail: o,
                            next: u ? u.next : a
                        }, s = e.shift();
                    return this
                        ...
                        for (e = e ? e.split(t) : _.keys(s), i = e.shift(); i;)
                            if (a = s[i], delete s[i], a && (n || r)) {
                                for (o = a.tail, a = a.next; a !== o;)
                                    u = a.callback, c = a.context, (n && u !== n || r && c !== r) && this.on(i, u, c), a = a.next;
                                i = e.shift()
                            }
                        return this
                    }
                ...
                trigger: function(e) {
                    ...
                    for (u = s.all, e = e.split(t), c = n.call(arguments, 1), r = e.shift(); r;) {
                        ...
                        if (i = u)
                            for (a = i.tail, o = [r].concat(c); (i = i.next) !== a;)
        ...
        (function(n) {
            ...
            t.exports = function(t) {
                ...
                t.File = function(r, s, u) {
                    ...
                    if (this._guessedType = h, i.isArray(s))
                        this._source = t.Promise.as(a(s), h), this._metaData.size = s.length;
                    else if (s && s.base64) {
                        ...
                        this._source = t.Promise.as(s.toString("base64"), h), this._metaData.size = s.length;
                    ...
                    thumbnailURL: function(e, t, n, r, i) {
                        ...
                        if (n = n || 100, r = null == r ? !0 : r, 0 >= n || n > 100)
                        ...
                        if (!i._previousSave)
                            if (i._source) {
                                ...
                                i._previousSave = t._request("files", i._name, null, "POST", a).then(function(e) {
                                    return i._name = e.name, i._url = e.url, i.id = e.objectId, e.size && (i._metaData.size = e.size), i
                                })
                            }
    ...
    12: [function(e, t) {
        ...
        t.exports = function(e) {
            e.GeoPoint = function(t, r) {
                n.isArray(t) ? (e.GeoPoint._validate(t[0], t[1]), this.latitude = t[0], this.longitude = t[1]) : n.isObject(t) ? (e.GeoPoint._validate(t.latitude, t.longitude), this.latitude = t.latitude, this.longitude = t.longitude) : n.isNumber(t) && n.isNumber(r) ? (e.GeoPoint._validate(t, r), this.latitude = t, this.longitude = r) : (this.latitude = 0, this.longitude = 0);
                var i = this;
    ...
    14: [function(e, t) {
        ...
        t.exports = function(e) {
            e.Object = function(t, r) {
                ...
                if (i && (t = n.extend({}, i, t)), r && r.collection && (this.collection = r.collection), this._serverData = {}, this._opSetQueue = [{}], this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = n.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {}, !this.set(t, {
                    silent: !0
                }))
                ...
                _toFullJSON: function(t) {
                    ...
                    return e._objectEach(r, function(n, i) {
                        ...
                        r[t] = e
                    }), n.has(this, "id") && (r.objectId = this.id), n.has(this, "createdAt") && (r.createdAt = n.isDate(this.createdAt) ? this.createdAt.toJSON() : this.createdAt), n.has(this, "updatedAt") && (r.updatedAt = n.isDate(this.updatedAt) ? this.updatedAt.toJSON() : this.updatedAt), r.__type = "Object", r.className = this.className, r
                },
                ...
                escape: function(t) {
                    ...
                    var i,
                        s = this.attributes[t];
                    return i = e._isNullOrUndefined(s) ? "" : n.escape(s.toString()), this._escapedAttributes[t] = i, i
                },
                has: function(t) {
                ...
                _mergeMagicFields: function(t) {
                    ...
                    e._arrayEach(i, function(i) {
                        t[i] && ("objectId" === i ? r.id = t[i] : r[i] = "createdAt" !== i && "updatedAt" !== i || n.isDate(t[i]) ? t[i] : e._parseDate(t[i]), delete t[i])
                    })
                },
                _startSave: function() {
                ...
                _finishSave: function(t) {
                    ...
                    this._opSetQueue = n.rest(this._opSetQueue), this._applyOpSet(i, this._serverData), this._mergeMagicFields(t);
                    var s = this;
                ...
                set: function(t, r, i) {
                    ...
                    return e._arrayEach(n.keys(s), function(t) {
                        ...
                        var a = !0;
                        r instanceof e.Op.Set && n.isEqual(o.attributes[t], r.value) && (a = !1), a && (delete u[t], i.silent ? o._silent[t] = !0 : i.changes[t] = !0);
                        var c = n.last(o._opSetQueue);
                        c[t] = r._mergeWithPrevious(c[t]), o._rebuildEstimatedDataForKey(t), a ? (o.changed[t] = o.attributes[t], i.silent || (o._pending[t] = !0)) : (delete o.changed[t], delete o._pending[t])
                ...
                save: function(t, r, i) {
                    var s,
                        a,
                        o;
                    if (n.isObject(t) || e._isNullOrUndefined(t) ? (s = t, o = r) : (s = {}, s[t] = r, o = i), !o && s) {
                    ...
                    return e.Object._findUnsavedChildren(f.attributes, d, p), d.length + p.length > 0 ? e.Object._deepSaveAsync(this.attributes, f).then(function() {
                        ...
                        return h = h.then(function(e, t, r) {
                            var i = f.parse(e, t, r);
                            return o.wait && (i = n.extend(s || {}, i)), f._finishSave(i), o.wait && f.set(a, l), f
                        }, function(t) {
                ...
                parse: function(t, r) {
                    ...
                    }), i.updatedAt || (i.updatedAt = i.createdAt), r && (this._existed = 201 !== r), i
                },
                clone: function() {
                ...
                change: function(t) {
                    ...
                    for (var a = function(e, t) {
                        ...
                        this._pending = {}, this.trigger("change", this, t), e._objectEach(this.changed, a), i._previousAttributes = n.clone(this.attributes);
                ...
                if (n.has(e.Object._classMap, t)) {
                    ...
                    r = r || {}, r.className = t, s = this._extend(r, i);
                ...
                var r = !0;
                return t instanceof e.Object ? r = !!t.id : n.isArray(t) ? e._arrayEach(t, function(t) {
            ...
            e.Op = function() {
                    ...
                    var i = this,
                        s = function(t) {
                            if (t instanceof e.Object) {
                                ...
                                if (i._targetClassName || (i._targetClassName = t.className), i._targetClassName !== t.className)
                ...
                toJSON: function() {
                    ...
                    return this.relationsToAdd.length > 0 && (s = n.map(this.relationsToAdd, i), e = {
                        __op: "AddRelation",
                        objects: s
                    }), this.relationsToRemove.length > 0 && (s = n.map(this.relationsToRemove, i), t = {
                        __op: "RemoveRelation",
                        objects: s
                    }), e && t ? {
                        __op: "Batch",
            ...
            "undefined" != typeof n && n.versions && n.versions.node && (a = !0), r.extend(i, {
                ...
                when: function(e) {
                    ...
                    var a = t.length,
                        ...
                        u = [],
                        c = [];
                    if (u.length = t.length, c.length = t.length, 0 === a)
                ...
                race: function(e) {
                    ...
                    var n = t.length,
                        ...
                        o = [],
                        u = [];
                    if (o.length = u.length = t.length, 0 === n)
                            ...
                            if (e)
                                if (i._isPromisesAPlusCompliant)
                                    try {
                                        ...
                                        i._debugError && n && console.error("Error occurred in promise resolve callback.", n.stack || n), t = [i.error(n)]
                                    }
                                else
                                    t = [e.apply(this, t)];
                            ...
                            if (t) {
                                if (i._isPromisesAPlusCompliant)
                                    try {
                                        ...
                                        i._debugError && r && console.error("Error occurred in promise reject callback.", r.stack || r), n = [i.error(r)]
                                    }
                                else
                                    n = [t(e)];
                ...
                _thenRunCallbacks: function(e, t) {
                    ...
                    return n = n || {}, this.then(function(e) {
                        return n.success ? n.success.apply(this, arguments) : t && t.trigger("sync", t, e, n), i.as.apply(i, arguments)
                    }, function(e) {
                        return n.error ? r.isUndefined(t) ? n.error(e) : n.error(t, e) : t && t.trigger("error", t, e, n), i.error(e)
                    })
                },
    ...
    17: [function(e, t) {
        ...
        t.exports = function(e) {
            e.Installation = e.Object.extend("_Installation"), e.Push = e.Push || {}, e.Push.send = function(t, n) {
                if (t.where && (t.where = t.where.toJSON().where), t.where && t.cql)
                    throw "Both where and cql can't be set";
                if (t.push_time && (t.push_time = t.push_time.toJSON()), t.expiration_time && (t.expiration_time = t.expiration_time.toJSON()), t.expiration_time && t.expiration_time_interval)
        ...
        t.exports = function(e) {
            e.Query = function(t) {
                ...
                e._arrayEach(t, function(e) {
                    if (n.isNull(r) && (r = e.className), r !== e.className)
                ...
                each: function(t, r) {
                    ...
                    s._limit = r.batchSize || 100, s._where = n.clone(this._where), s._include = n.clone(this._include), s.ascending("objectId");
                    var a = !1;
                    return e.Promise._continueWhile(function() {
                        return !a
                    }, function() {
        ...
        t.exports = function(e) {
            e.Role = e.Object.extend("_Role", {
                constructor: function(t, r) {
                    n.isString(t) && r instanceof e.ACL ? (e.Object.prototype.constructor.call(this, null, null), this.setName(t), this.setACL(r)) : e.Object.prototype.constructor.call(this, t, r)
                },
                getName: function() {
        ...
        t.exports = function(e) {
            e.SearchSortBuilder = function() {
                ...
                toJSON: function() {
                    ...
                    if (delete t.where, this.className && (t.clazz = this.className), this._sid && (t.sid = this._sid), !this._queryString)
                        throw "Please set query string.";
                    if (t.q = this._queryString, this._highlights && (t.highlights = this._highlights.join(",")), this._sortBuilder && t.order)
        ...
        t.exports = function(e) {
            e.Status = function(e, t) {
                ...
                _finishFetch: function(t) {
                    this.id = t.objectId, this.createdAt = e._parseDate(t.createdAt), this.updatedAt = e._parseDate(t.updatedAt), this.messageId = t.messageId, delete t.messageId, delete t.objectId, delete t.createdAt, delete t.updatedAt, this.data = e._decode(void 0, t)
                }
        ...
        t.exports = function(e) {
            e.User = e.Object.extend("_User", {
                ...
                _linkWith: function(t, r) {
                    var i;
                    if (n.isString(t) ? (i = t, t = e.User._authProviders[t]) : i = t.getAuthType(), n.has(r, "authData")) {
                ...
                signUp: function(t, r) {
                    ...
                    if (!s || "" === s)
                        return i = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up user with an empty name."), r && r.error && r.error(this, i), e.Promise.error(i);
                    var a = t && t.password || this.get("password");
                    if (!a || "" === a)
                        return i = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up user with an empty password."), r && r.error && r.error(this, i), e.Promise.error(i);
                    var o = n.clone(r);
                ...
                signUpOrlogInWithMobilePhone: function(t, r) {
                    ...
                    if (!s || "" === s)
                        return i = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up or login user by mobilePhoneNumber with an empty mobilePhoneNumber."), r && r.error && r.error(this, i), e.Promise.error(i);
                    var a = t && t.smsCode || this.get("smsCode");
                    if (!a || "" === a)
                        return i = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up or login user by mobilePhoneNumber  with an empty smsCode."), r && r.error && r.error(this, i), e.Promise.error(i);
                    var o = n.clone(r);
                    return o._makeRequest = function(t, n, r, i, s) {
                        return e._request("usersByMobilePhone", null, null, "POST", s)
                    }, o.success = function(e) {
                        e._handleSaveResult(!0), delete e.attributes.smsCode, delete e._serverData.smsCode, r.success && r.success.apply(this, arguments)
                    }, this.save(t, o)
                },
                logIn: function(t) {
                    var n = this,
                    ...
                    return r.then(function(e, t, r) {
                        var i = n.parse(e, t, r);
                        return n._finishFetch(i), n._handleSaveResult(!0), i.smsCode || delete n.attributes.smsCode, n
                    })._thenRunCallbacks(t, this)
                },
                save: function(t, r, i) {
                    var s,
                        a;
                    n.isObject(t) || n.isNull(t) || n.isUndefined(t) ? (s = t, a = r) : (s = {}, s[t] = r, a = i), a = a || {};
                    var o = n.clone(a);
                    return o.success = function(e) {
                ...
                logOut: function() {
                    null !== e.User._currentUser && (e.User._currentUser._logOutWithAll(), e.User._currentUser._isCurrentUser = !1), e.User._currentUserMatchesDisk = !0, e.User._currentUser = null, e.localStorage.removeItem(e._getAVPath(e.User._CURRENT_USER_KEY))
                },
                followerQuery: function(t) {
                    if (!t || !n.isString(t))
                        throw "Invalid user object id.";
                    var r = new e.FriendShipQuery("_Follower");
                    return r._friendshipTag = "follower", r.equalTo("user", e.Object.createWithoutData("_User", t)), r
                },
                followeeQuery: function(t) {
                    if (!t || !n.isString(t))
                        throw "Invalid user object id.";
                    var r = new e.FriendShipQuery("_Followee");
                    return r._friendshipTag = "followee", r.equalTo("user", e.Object.createWithoutData("_User", t)), r
                },
            ...
            t.exports = function(e) {
                ...
                var t = function() {},
                    r = function(n, r, i) {
                        ...
                        }, e._.extend(s, n), t.prototype = n.prototype, s.prototype = new t, r && e._.extend(s.prototype, r), i && e._.extend(s, i), s.prototype.constructor = s, s.__super__ = n.prototype, s
                    };
                e.serverURL = "https://api.leancloud.cn", "undefined" != typeof n && n.versions && n.versions.node && (e._isNode = !0), e.initialize = function(t, n, r) {
                    if (r)
                    ...
                    void 0 !== e.applicationId && t !== e.applicationId && n !== e.applicationKey && r !== e.masterKey && console.warn("AVOSCloud SDK is already initialized, please don't reinitialize it."), e.applicationId = t, e.applicationKey = n, e.masterKey = r, e._useMasterKey = !1
                    ...
                    }, l.open(t, r, !0), l.setRequestHeader("Content-Type", "text/plain"), e._isNode && l.setRequestHeader("User-Agent", "AV/" + e.VERSION + " (NodeJS " + n.versions.node + ")"), l.send(i), u._thenRunCallbacks(o)
                    ...
                    if ("batch" !== t && "classes" !== t && "files" !== t && "date" !== t && "functions" !== t && "login" !== t && "push" !== t && "search/select" !== t && "requestPasswordReset" !== t && "requestEmailVerify" !== t && "requestPasswordResetBySmsCode" !== t && "resetPasswordBySmsCode" !== t && "requestMobilePhoneVerify" !== t && "requestLoginSmsCode" !== t && "verifyMobilePhone" !== t && "requestSmsCode" !== t && "verifySmsCode" !== t && "users" !== t && "usersByMobilePhone" !== t && "cloudQuery" !== t && "qiniu" !== t && "statuses" !== t && "bigquery" !== t && "search/select" !== t && "subscribe/statuses/count" !== t && "subscribe/statuses" !== t && !/users\/[^\/]+\/updatePassword/.test(t) && !/users\/[^\/]+\/friendship\/[^\/]+/.test(t))
                        throw "Bad route: '" + t + "'.";
                    var a = e.serverURL;
                    "/" !== a.charAt(a.length - 1) && (a += "/"), a += "1.1/" + t, n && (a += "/" + n), r && (a += "/" + r), ("users" === t || "classes" === t) && s && s._fetchWhenSave && (delete s._fetchWhenSave, a += "?new=true"), s = e._.clone(s || {}), "POST" !== i && (s._method = i, i = "POST"), s._ApplicationId = e.applicationId, s._ApplicationKey = e.applicationKey, e._isNullOrUndefined(e.applicationProduction) || (s._ApplicationProduction = e.applicationProduction), e._useMasterKey && (s._MasterKey = e.masterKey), s._ClientVersion = e.VERSION, s._InstallationId = e._getInstallationId();
                    ...
                    if (t instanceof e.Object) {
                        ...
                        if (!n || i.include(n, t) || !t._hasData)
                            return t._toPointer();
                        if (!t.dirty())
                            return n = n.concat(t), e._encode(t._toFullJSON(n), n, r);
    ...
    27: [function(e, t) {
        ...
        }, o.title = "browser", o.browser = !0, o.env = {}, o.argv = [], o.version = "", o.versions = {}, o.on = s, o.addListener = s, o.once = s, o.off = s, o.removeListener = s, o.removeAllListeners = s, o.emit = s, o.binding = function() {
        ...
        (function() {
            ...
            function i(e, t, n) {
                return function(r, i, s) {
                    ...
                    if (i !== i)
                        return s = t(f.call(r, a, o), y.isNaN), s >= 0 ? s + a : -1;
            ...
            function s(e, t) {
                ...
                for (y.has(e, s) && !y.contains(t, s) && t.push(s); n--;)
                    s = T[n], s in e && e[s] !== i[s] && !y.contains(t, s) && t.push(s)
            }
            var a = this,
                o = a._,
                u = Array.prototype,
            ...
            y.each = y.forEach = function(e, t, n) {
                ...
                var r;
                return r = E(e) ? y.findIndex(e, t, n) : y.findKey(e, t, n), void 0 !== r && -1 !== r ? e[r] : void 0
                ...
                t = O(t, n);
                for (var r = !E(e) && y.keys(e), i = (r || e).length, s = 0; i > s; s++) {
                    var a = r ? r[s] : s;
                    if (!t(e[a], a, e))
                        return !1
                }
                ...
                return E(e) || (e = y.values(e)), ("number" != typeof n || r) && (n = 0), y.indexOf(e, t, n) >= 0
                ...
                if (null == t && null != e) {
                    ...
                    t = O(t, n), y.each(e, function(e, n, r) {
                ...
                for (var t, n = E(e) ? e : y.values(e), r = n.length, i = Array(r), s = 0; r > s; s++)
                    t = y.random(0, s), t !== s && (i[s] = i[t]), i[t] = n[s];
                return i
            ...
            y.groupBy = C(function(e, t, n) {
                ...
                return e ? y.isArray(e) ? f.call(e) : E(e) ? y.map(e, y.identity) : y.values(e) : []
            }, y.size = function(e) {
            ...
            var R = function(e, t, n, r) {
                for (var i = [], s = 0, a = r || 0, o = N(e); o > a; a++) {
                    var u = e[a];
            ...
            y.flatten = function(e, t) {
                ...
                for (var r = Math.max(Math.ceil((t - e) / n), 0), i = Array(r), s = 0; r > s; s++, e += n)
                    i[s] = e;
                return i
            };
            ...
            y.bind = function(e, t) {
                ...
                for (t = 1; r > t; t++)
                    n = arguments[t], e[n] = y.bind(e[n], e);
                return e
            ...
            var U = function(e, t, n, r) {
                ...
                if (n.push(e), r.push(t), s) {
                    ...
                    var c,
                        l = y.keys(e);
                    if (u = l.length, y.keys(t).length !== u)
                        return !1;
                    for (; u--;)
                        if (c = l[u], !y.has(t, c) || !U(e[c], t[c], n, r))
                            return !1
                }
